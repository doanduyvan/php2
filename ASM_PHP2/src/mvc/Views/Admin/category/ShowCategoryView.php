    ...
    <div class="flex justify-between items-center">
        <div>
            <form action="" method="get">
                <input name="search" class="bg-[#F9F9F9] p-[10px] rounded-[10px] outline-none" type="text" placeholder="Search Category">
        ...
        <div>
            <a class="block bg-[#17C653] hover:bg-[#04B440] text-white px-[20px] rounded-[10px] leading-[40px]" href="admin/category/add">Add Category</a>
        </div>
    </div>
    ...
    <div class="mt-[25px]">
        <ul class="ul">
            ...
            <div id="show_category">
                ...
                <li class="li list">
                    <div class="left">Điện thoại 2</div>
                    <div class="right">
                        <a href="">
...
<script>
    const arrCategory = <?= json_encode($fulldata) ?>;
        ...
        data.forEach(value => {
            ...
            <div class="left">${value.name}</div>
                    <div class="right">
                        ...
                        <p class="delete_category cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path fill="#ff0000" d="M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z" />
                            </svg>
                        </p>
            ...
            li.onclick = function(e) {
                if (e.target.closest('.delete_category')) {
                    let id = value.id;
                    let check = confirm(`Bạn có chắc chắn muốn xóa danh mục ${value.name} không?`);
                    if(check){
